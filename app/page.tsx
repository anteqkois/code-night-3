...
export default function Home() {
  ...
  return (
    <div>
      <main>
        <div className="fixed blur-sm bg-cover z-[-20] bg-no-repeat top-0 left-0 h-screen w-full bg-[url('https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Y2FyfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60')]" />
        <div className="mx-32 z-50">
          <div className="h-[calc(100vh-91px)] flex justify-center items-start pt-20 ">
