...
export default function Home() {
  ...
  return (
    <div>
      <main>
        <div className="mx-32">
          <div className='h-[calc(100vh-91px)] flex justify-center items-start pt-20 bg-gradient-to-r from-primary-orange'>
            <div className='w-[450px] h-96 mr-20 rounded shadow-2xl bg-white p-2'>
              ...
              <div className='flex justify-evenly pt-2'>
                <span className='bg-black rounded px-2 py-[2px] text-white'>Licytacje</span>
